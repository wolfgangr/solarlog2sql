...
) ENGINE=Aria DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci PAGE_CHECKSUM=1 ROW_FORMAT=FIXED TRANSACTIONAL=0 COMMENT='aus days.csv';
...
) ENGINE=Aria DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci PAGE_CHECKSUM=1 ROW_FORMAT=FIXED TRANSACTIONAL=0;
...
CREATE TABLE `min_INV` (
  ...
  KEY `Inv` (`Inv`)
) ENGINE=Aria DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci PAGE_CHECKSUM=1 ROW_FORMAT=FIXED TRANSACTIONAL=0 COMMENT='aus min*.csv, Inverterdaten';
...
CREATE TABLE `min_MPP` (
  ...
  KEY `Inv` (`Inv`),
  KEY `Inv_MPP` (`Inv`,`MPP`)
) ENGINE=Aria DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci PAGE_CHECKSUM=1 ROW_FORMAT=FIXED TRANSACTIONAL=0 COMMENT='aus min*.csv, string-Daten';
...
CREATE TABLE `months` (
  ...
  `Psum` int(10) NOT NULL,
  PRIMARY KEY (`Date`,`Inv`)
) ENGINE=Aria DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci PAGE_CHECKSUM=1 ROW_FORMAT=FIXED TRANSACTIONAL=0 COMMENT='aus months.csv';
...
CREATE TABLE `years` (
  ...
  `Psum` int(10) NOT NULL,
  PRIMARY KEY (`Date`,`Inv`)
) ENGINE=Aria DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci PAGE_CHECKSUM=1 ROW_FORMAT=FIXED TRANSACTIONAL=0 COMMENT='aus years.csv';
